...
def user():
    ...
    for i in range(6):
        ...
        password += random.choice(list('1234567890abcdefghijklmnopqrstuwyxwzABCDEFGHIGKLMNOPQRSTUVYXWZ'))
    user = User (name= 'Andrey_Bergan', email= 'Andrey_Bergan_12a_' + login[:3] + '@ya.ru', password = password)
